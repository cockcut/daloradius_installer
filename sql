...
#	driver = "rlm_sql_${dialect}"
	...
	mysql {
		...
		#tls {
		#	ca_file = "/etc/raddb/certs/my_ca.crt"
		#	ca_path = "/etc/raddb/certs/"
		#	certificate_file = "/etc/raddb/certs/client.crt"
		#	private_key_file = "/etc/raddb/certs/client.key"
	...
	postgresql {
		...
		# uses its connection parameters - see the radius_db="radius"
		# this file
